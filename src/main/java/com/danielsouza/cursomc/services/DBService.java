...
import com.danielsouza.cursomc.domain.PagamentoComCartao;
...
public class DBService {
	...
	public void instantiateDevDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "josesilvaskt6@gmail.com", "26159680846", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("2693547852", "985432546"));

		Cliente cli2 = new Cliente(null, "Ana Silva", "larissamanuelayou@gmail.com", "96906976842", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("988587565", "985469858"));
		...
		Endereco e3 = new Endereco(null, "Avenida Floriano", "1233", null, "Centro", "1312345", cli2, c2);
